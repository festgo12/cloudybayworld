...
class CategoryController extends Controller
{
        ...
        if ($file = $request->file('photo'))
         {
            ...
            $file->move('assets/uploads/cats',$name);
            $input['photo'] = $name;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            if ($file = $request->file('photo'))
            {
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/assets/uploads/cats/'.$data->photo)) {
                        unlink(public_path().'/assets/uploads/cats/'.$data->photo);
                    }
                }
            $input['photo'] = $name;
            }
    ...
    public function destroy($id)
    {
        ...
        if (file_exists(public_path().'/assets/uploads/cats/'.$data->image)) {
            unlink(public_path().'/assets/uploads/cats/'.$data->image);
        }
        $data->delete();
        cache()->forget('categories');
        //--- Redirect Section
