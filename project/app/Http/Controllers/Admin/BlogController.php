...
class BlogController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->editColumn('photo', function(Blog $data) {
                                $photo = $data->photo ? url('assets/uploads/blogs/'.$data->photo):url('assets/uploads/noimage.png');
    ...
    public function create()
    {
        ...
        $shops = Shop::all();
        return view('admin.blog.create',compact('cats', 'shops'));
    }
    ...
    public function edit($id)
    {
        ...
        $select_shop = Shop::find($data->shop_id);
        return view('admin.blog.edit',compact('data','cats','shops', 'select_shop' ));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input = $request->all();
            ...
            {              
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/assets/uploads/blogs/'.$data->photo)) {
                        unlink(public_path().'/assets/uploads/blogs/'.$data->photo);
                    }
                }            
            $input['photo'] = $name;
            } 
