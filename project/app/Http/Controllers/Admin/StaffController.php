    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('photo')) 
         {      
            ...
            $file->move('assets/admin/images/admins',$name);           
            $input['photo'] = $name;
        } 
        $input['role'] = 'Staff';
        // $input['role'] = 'Staff';
        ...
        if($id != Auth::guard('admin')->user()->id)
        {
            ...
            $data = Admin::findOrFail($id);        
                ...
                {              
                    ...
                    if($data->photo != null)
                    {
                        if (file_exists(public_path().'/assets/admin/images/admins/'.$data->photo)) {
                            unlink(public_path().'/assets/admin/images/admins/'.$data->photo);
                        }
                    }            
                $input['photo'] = $name;
                } 
