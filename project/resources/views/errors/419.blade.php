  ...
  <body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="error-wrapper">
        <div class="container"><img class="img-700" src="{{ asset('assets/images/logo/logo.png') }}" alt="">
          <div class="error-heading">
            <h2 class="headline font-info">419 - csrf Token</h2>
          </div>
          <div class="col-md-8 offset-md-2">
            <p class="sub-content">The page you are looking for might have been moved, renamed, or might never existed.</p>
          </div>
          <div><a class="btn btn-info btn-lg" href="{{ route('home') }}">BACK TO HOME</a></div>
        </div>
      </div>
      <!-- error-400 end-->
    </div>
