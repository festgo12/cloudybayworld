...
<li>
    ...
    @foreach(Session::get('cart')->items as $product)
      <li class="mt-0 cremove{{ $product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values']) }}">
          ...
          <div class="media"><img class="img-fluid rounded-circle me-3 " src="{{ $product['item']['image'] ? asset('assets/uploads/products/'.$product['item']['image']):asset('assets/uploads/noimage.png') }}" alt="">
