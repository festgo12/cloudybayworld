...
<head>
    ...
    <meta name="description" content="Cloudbay business with unlimited possibilities.">
    <meta name="keywords" content="Cloudbay web app">
    <meta name="author" content="cloudbay">
    <link rel="icon" href="./assets/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="./assets/images/favicon.png" type="image/x-icon">
    <title>Cloudbay - Sign up</title>
    <!-- Google font-->
              ...
              <div class="login-main"> 
                <form class="theme-form"method="POST" action="{{ route('register') }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row g-2">
                      <div class="col-6">
                        <input class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" type="text" required="" autocomplete="firstname" placeholder="First name">
                      ...
                      <div class="col-6">
                        <input class="form-control @error('lastname') is-invalid @enderror" name="lastname" type="text" value="{{ old('lastname') }}" required="" autocomplete="lastname" placeholder="Last name">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" type="text" autocomplete="username" required="" placeholder="john22">
