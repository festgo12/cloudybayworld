...
@section('content')
                        ...
                        @include('includes.admin.form-both')  
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/admin/images/avatar/'.$data->photo):asset('assets/admin/images/avatar/noimage.png') }});">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Firstname') }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Lastname') }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
