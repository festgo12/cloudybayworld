                                ...
                                @foreach($cart->items as $key => $product)
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                $shop = App\Models\Shop::find($product['item']['shop_id']);
                                                @endphp
                                                @if(isset($user))
                                                <a target="_blank" href="{{route('admin-vendor-show',$user->id)}}">{{$user->username}} - {{ $user->shop->shopName }}</a>
                                                @else
                                                {{ __('Shop Removed') }}
                                                @endif
                                                @else 
                                                <a  href="javascript:;">CloudBay World</a>
                                                @endif
