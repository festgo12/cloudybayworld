                        ...
                        @include('includes.admin.form-error') 
											<form id="geniusformdata" action="{{ route('admin-staff-store') }}" method="POST" enctype="multipart/form-data">
						                        ...
						                        <div class="row">
						                          ...
						                          <div class="col-lg-7">
						                            <div class="img-upload">
						                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/avatar/noimage.png') }});">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="firstname" placeholder="{{ __("First Name") }}" required="" value="">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="lastname" placeholder="{{ __("Last Name") }}" required="" value="">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="username" placeholder="{{ __("User Name") }}" required="" value="">
													</div>
												</div>
