...
@section('content')
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Shop Categories') }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
											</li>
											<li><a href="javascript:;">{{ __('Manage Shop Categories') }}</a></li>
											<li>
												<a href="{{ route('admin-shopcat-index') }}">{{ __(' Shop Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-shopcat-datatables') }}',
               columns: [
                        { data: 'category_name', name: 'category_name' },
						{ data: 'icon_path', name: 'slug' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-shopcat-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
