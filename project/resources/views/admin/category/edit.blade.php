                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/uploads/cats/'.$data->photo):asset('assets/uploads/noimage.png') }});">
						          ...
						          <div class="{{ $data->is_featured == 0 ? "showbox":"" }}">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Current Featured Icon') }}*</h4>
																<h4 class="sub-heading">{{ __('Current Featured Icon') }}*</h4>
														</div>
													</div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="icon" placeholder="{{ __('Enter Icon Class') }}" required="" value="{{$data->icon}}">
