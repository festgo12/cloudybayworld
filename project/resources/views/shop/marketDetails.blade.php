                ...
                <div class="default-according style-1 faq-accordion job-accordion" id="accordionoc1">
                    ...
                    <div class="col-xl-4 xl-50 box-col-6">
                        ...
                        <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                            ...
                            <div class="collapse show" id="collapseicon2" aria-labelledby="collapseicon2"
                            data-bs-parent="#accordion">
                            <div class="card-body filter-cards-view"><span class="f-w-600 mb-2 d-block"></span>
                                <br>
                    ...
                    <div class="col-xl-12 xl-100 box-col-6">
                        ...
                        <div class="collapse show" id="collapseicon13" data-bs-parent="#accordion"
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                ...
                                data-size="1600x950"><img src="assets/images/lightgallry/01.jpg"
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/02.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/02.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/03.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/03.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/04.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/04.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/05.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/05.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/011.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/011.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/010.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/010.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                            ...
                            <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                href="assets/images/lightgallry/08.jpg" itemprop="contentUrl"
                                data-size="1600x950"><img src="assets/images/lightgallry/08.jpg"
                                    itemprop="thumbnail" alt="Image description">
                                <div class="caption">
                                    <h4><b>Photos</b><i class="fa fa-heart" style="float: right; color:red;"></i></h4>
                                </div>
                    ...
                    <div class="col-xl-12 xl-100 box-col-6">
                        ...
                        <div class="collapse show" id="collapseicon13" data-bs-parent="#accordion"
                            ...
                            <figure class="col-md-12 col-sm-12" itemprop="associatedMedia" itemscope="">
                                <iframe width="100%" height="315" src="https://www.youtube.com/embed/XYZ123"
                            ...
                            <figure class="col-md-12 col-sm-12" itemprop="associatedMedia" itemscope="">
                                ...
                                frameborder="0" allowfullscreen></iframe>
                                <div class="caption">
                                <h4><b>The creative process - Dj Rain</b></h4>
                                </div></a>
                            </figure>
                            </div>
                        </div>
