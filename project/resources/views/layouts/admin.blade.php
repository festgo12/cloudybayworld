								...
								<ul class="list">
									...
									<li class="bell-area">
										<a id="notf_product" class="dropdown-toggle-1" href="javascript:;">
											...
											<span id="product-notf-count">{{ DB::table('notifications')->where('type','App\Notifications\productCreatedAdmin')->count() }}</span>
										</a>
									...
									<li class="bell-area">
										<a id="notf_user" class="dropdown-toggle-1" href="javascript:;">
											...
											<span id="user-notf-count">{{ DB::table('notifications')->where('type','App\Notifications\UserCreatedAdmin')->count() }}</span>
										</a>
										<div class="dropdown-menu">
									...
									<li class="bell-area">
										<a id="notf_order" class="dropdown-toggle-1" href="javascript:;">
											...
											<span id="order-notf-count">{{ DB::table('notifications')->where('type','App\Notifications\newOrderCreated')->count() }}</span>
										</a>
										<div class="dropdown-menu">
									...
									<li class="login-profile-area">
										<a class="dropdown-toggle-1" href="javascript:;">
											<div class="user-img">
												<img src="{{ Auth::guard('admin')->user()->photo ? asset('assets/admin/images/avatar/'.Auth::guard('admin')->user()->photo ):asset('assets/admin/images/avatar/noimage.png') }}" alt="">
											</div>
										</a>
										<div class="dropdown-menu">
