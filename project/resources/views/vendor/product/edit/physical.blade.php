...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
										<h4 class="heading"> Physical Product <a class="add-btn" href="{{ route('vendor-prod-index') }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
										<ul class="links">
											<li>
											<a href="{{ route('vendor-dashboard') }}">Back</a>
											</li>
											<li>
											...
											<li>
												<a href="{{ route('vendor-prod-edit',$data->id) }}">Edit Product</a>
											</li>
										</ul>
									</div>
								</div>
											...
											<div class="body-area">
												...
												<input type="hidden" name="user_id" value="{{ $data->user_id }}">
							                     ...
							                     <div class="row">
							                      ...
							                      <input type="hidden" id="feature_photo" name="image" value="{{ $data->image }}" accept="image/*">
                      ...
                      if(data[0] == 0)
                      {
        				...
        				$('.selected-image .row').append('<div class="col-sm-6">'+
                                        '<div class="img gallery-img">'+
                                            ...
                                            '</span>'+
                                            '<a href="'+'{{asset('assets/uploads/products/gal').'/'}}'+arr[k]['photo']+'" target="_blank">'+
                                            '<img src="'+'{{asset('assets/uploads/products/gal').'/'}}'+arr[k]['photo']+'" alt="gallery image">'+
                                            '</a>'+
                                        '</div>'+
                                  	'</div>');
                          }
...
$('.cropme').simpleCropper();
  ...
  $(document).ready(function() {
    ...
    let html = `<img src="{{ empty($data->image) ? asset('assets/uploads/noimage.png') : (filter_var($data->image, FILTER_VALIDATE_URL) ? $data->image : asset('assets/uploads/products/'.$data->image)) }}" alt="">`;
