			...
			<div class="col-lg-12">
					...
					<ul class="links">
                      ...
                      <li>
						...
						<li>
							<a href="javascript:;">Digital Product</a>
						</li>
						<li>
						...
						<div class="product-description">
							<div class="body-area">
								...
								<input type="hidden" name="user_id" value="{{ $data->user_id }}">
									...
									<input type="hidden" id="feature_photo" name="image" value="{{ $data->image }}">
				...
				if (data[0] == 0) {
					...
					for (var k in arr) {
						$('.selected-image .row').append('<div class="col-sm-6">' +
							...
							'</span>' +
							'<a href="' + '{{asset('
							assets/uploads/products/gal ').' / '}}' + arr[k]['photo'] +
							'" target="_blank">' +
							'<img src="' + '{{asset('
							assets/uploads/products/gal ').' / '}}' + arr[k]['photo'] +
							'" alt="gallery image">' +
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		let html =
			`<img src="{{ empty($data->image) ? asset('assets/uploads/noimage.png') : asset('assets/uploads/products/'.$data->image) }}" alt="">`;
