                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('vendor-shipping-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="subtitle" placeholder="5 days" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="price" placeholder="2723" required="" value="" min="0" step="0.01">
                          </div>
                        </div>
